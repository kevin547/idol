...
public class Constants {
    ...
    public static final String DATE_FORMAT_6_STR = "yyMMdd";

    public static final String TIME_FORMAT_6_STR = "HHmmss";
    ...
    public static final String D_STAR = "**";
    ...
    public static final String NULL_P = null;
